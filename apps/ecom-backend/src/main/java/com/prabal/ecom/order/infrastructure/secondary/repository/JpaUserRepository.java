...
import com.prabal.ecom.order.infrastructure.secondary.entity.UserEntity;
...
public interface JpaUserRepository extends JpaRepository<UserEntity, Long> {
  ...
  @Query("UPDATE UserEntity user " +
    ...
    "user.addressCountry = :country, user.addressZipCode = :postalCode " +
    "WHERE user.publicId = :userPublicId")
  void updateAddress(UUID userPublicId, String street, String city, String country, String postalCode);
}
