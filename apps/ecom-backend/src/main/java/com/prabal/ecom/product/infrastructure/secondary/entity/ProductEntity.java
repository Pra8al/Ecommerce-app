package com.prabal.ecom.product.infrastructure.secondary.entity;
...
import com.prabal.ecom.shared.jpa.AbstractAuditingEntity;
...
public class ProductEntity extends AbstractAuditingEntity<Long> {
  ...
  public ProductEntity(Long id, String brand, String color, String description, String name, double price, boolean featured, ProductSize size, UUID publicId, int numberInStock, Set<PictureEntity> pictures, CategoryEntity category) {
    this.id = id;
    this.brand = brand;
    this.color = color;
  ...
  public static Product to(ProductEntity productEntity) {
    return ProductBuilder.product()
      ...
      .numberInStock(productEntity.getNumberInStock())
      .build();
  }
